            ...
            <v-row dense>
                ...
                >
                    <div class="profileContainer">
                        ...
                        Creating well-rounded and efficient APIs, optimizing database queries, and designing sleek and modern UIs has become my passion.</p>
                        <p class="paragraph">I love traveling- summers in Italy are my favourite! In my free time I'm usually gaming with my husband, watching horror movies, and thrifting fun stuff for my home.</p>
                    </div>
                </v-col>
            </v-row>
        </v-container>
